...
GENO_STATUS={'AVAILABLE':'AVAILABLE', 'NOT AVAILABLE':'NOT AVAILABLE', 'DONE':'PASSED', 'FAILED':'FAILED'}
SEQUENCING_STATUS={'NEW':'NEW', 'DONE':'SEQUENCED', 'FAILED':'IGNORED'}
PROJECT_STATUS={'NEW':'OPEN', 'DONE':'CLOSED', 'FAILED':'ABORTED'}
LIBRARY_STATUS={'DONE':'PASSED', 'FAILED':'FAILED'}
DELIVERY_STATUS={'NEW':'NOT DELIVERED', 'DONE':'DELIVERED'}
